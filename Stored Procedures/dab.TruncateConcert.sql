...
if  exists (
    ...
    from
        sys.objects
    where
        object_id = object_id(N'dab.TruncateConcert') and
        type in (N'P', N'PC'))
begin
    drop procedure dab.TruncateConcert
end
go

create procedure dab.TruncateConcert
--<parameters>
as
declare
	@procedure_name varchar(200) = 'dab.TruncateConcert',
